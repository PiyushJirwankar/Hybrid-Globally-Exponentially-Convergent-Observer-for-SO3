...
\begin{theorem}[Hybrid passive complementary filter]\label{theorem:main}
    Let $\textblue{\mathcal{A}\coloneqq \{I\}\times \{0\}\times \mathbb{S}^2 \subset \SOthree\times Q\times \mathbb{S}^2}$. Assume that Assumption \ref{ass:no_meas_noise} holds and $\Omega(t)$ is a bounded and absolutely continuous signal. If there exist positive constants \textblue{$k_p$, $\overline{k_p}$}, $c_0$, $c_1$ and  $\theta^*\in \R{}$ such that 
        \begin{enumerate}[(a)]
