...
\begin{subequations}
\begin{align}
    C_0 &\coloneqq {\left\{\Rtilde^y \in \SOthree \mid \normSOthree{\Rtilde^y} \leq c_0 \right\}}\\
    C_1 &\coloneqq {\left\{\Rtilde^y \in \SOthree \mid \normSOthree{\Rtilde^y} \geq c_1 \right\}}\\
    D_0 &\coloneqq {\left\{\Rtilde^y \in \SOthree \mid \normSOthree{\Rtilde^y} \geq c_0 \right\}}\\
    D_1 &\coloneqq {\left\{\Rtilde^y \in \SOthree \mid \normSOthree{\Rtilde^y} \leq c_1 \right\}}\\
...
\begin{remark}
    If \ref{item:b-bullet} in Theorem \ref{theorem:main} does not hold, the set $\mathcal{A}$ becomes only globally asymptotically stable for $\tilde{\mathcal{H}}_{PCF}$. 
\end{remark}
