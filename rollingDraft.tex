...
\begin{definition}[\textblue{Distance between two points}]\label{def:dist_between_points}
    ...
    \begin{align*}
        \textcolor{red}{{|R_1|_{R_2}}^2 \coloneqq \frac{1}{4}\trace{I - R_2^\top R_1} \quad \forall R_1, R_2 \in \SOthree.}
    \end{align*}
\end{definition}
...
where 
\begin{align}
    \textblue{\lambda} &\textblue{\coloneqq \sqrt{{\frac{2 - \normSOthree{\Rstar}^2 + 2\sqrt{(1-\normSOthree{\Rstar}^2)(1-c_1)}}{1 - \normSOthree{\Rstar}^2 - \sqrt{\frac{1}{c_1}-1}}}}. \label{eq:lambda}}
\end{align}
