...
\end{align}
Note that condition \ref{item:b-bullet} results in $\textblue{\lambda \in \R{}_{\geq 0}}$. Next, since $(\Rtilde(T,0), q(T,0), r(T,0))\in D_1\times \{1\}\times \overline{\mathcal{B}}$ results in $(\Rtilde(T,1), q(T,1), r(T,1))\in C_0\times \{0\}\times \overline{\mathcal{B}}$, we have
